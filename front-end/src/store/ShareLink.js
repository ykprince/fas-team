...
const STIE_ADDRESS = 'http://localhost:8080/'
export { KAKAO_JS_API_KEY, KAKAO_REST_API_KEY, DEV_REDIRECT_URI, APP_NUMBER, KAKAO_URI, CLIENT_ID, APP_ADMIN_KEY, STIE_ADDRESS }
