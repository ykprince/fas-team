...
public class BookGetherDto {
    private String bgIdx;         // 모임 번호
    private int uid;            // 등록자 고유번호
    private int type;           // 독후감 타입 ( 1: 읽은 책, 2: 읽고 있는 책, 3: 읽을 책)
    private String staDt;      // 독서 시작 일자
    private String endDt;      // 독서 종료 일자
    private int rate;           // 읽은 후 평점
    private int rateEx;        // 읽기 전 평점
    private String commentEx;  // 읽기 전 기대문구
    private int readPage;      // 읽은 쪽수
    private String bgColor;    // 배경 컬러
